...
void renderActorHud()
{
    ...
    // Pickup glow rendering moved to the depth-tested
    // selva::render::renderPickupSprites pass in the WorldRenderer
    // pipeline; HUD overlay path retired so pickups occlude correctly
    // against terrain + meshes (previously visible through ground +
    // walls).
