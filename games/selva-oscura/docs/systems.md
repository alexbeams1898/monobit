...
- **Enemies / spawn pipeline** — `spawnEnemyFromDecl`, `tickEnemies` (per-frame tick), `applyEnemyHitReact`, `fireEnemyDeath`, `tickPendingAttackSpawns` (windup deferred-spawn) — [include/gameplay/Enemies.h](../include/gameplay/Enemies.h)
- **EnemyArchetype** — JSON-loaded archetype: actions, faction, is_npc, skeleton_id, clip overrides per family (idle / walk / death / flinch / hit_react), hurtbox_decls, lockon_points, boss fields (is_boss, boss_name, initial_state, engage_clip, initial_freeze_at_seconds, max_hp_override) — [include/gameplay/EnemyArchetype.h](../include/gameplay/EnemyArchetype.h)
