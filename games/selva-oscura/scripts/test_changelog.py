...
Run: python games/selva-oscura/scripts/test_changelog.py
"""
...
class TestValidatePrBody(unittest.TestCase):
    def test_full_pr_body_valid(self) -> None:
        body = textwrap.dedent(
            ...
            ## Changelog
            - Added: Heightmap terrain with gentle colle and plateau spawn.
            - Performance: Cached terrain region per-frame uniforms.
...
class TestChangelogFile(unittest.TestCase):
    ...
    def test_release_promotes_unreleased(self) -> None:
        ...
        self.assertIn("[0.2.0]: https://github.com/alexbeams1898/selva-oscura-releases/releases/tag/v0.2.0", result)
        # Unreleased link ref points at 0.2.0...HEAD
        self.assertIn("[unreleased]: https://github.com/alexbeams1898/selva-oscura-releases/compare/v0.2.0...HEAD", result)
