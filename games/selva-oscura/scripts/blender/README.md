...
games/selva-oscura/scripts/blender/rebookend.sh \
    --source "games/selva-oscura/assets/characters/humanoid/source/Pro Sword and Shield Pack/sword and shield slash.fbx" \
    --source-time 0.683 \
    --target "games/selva-oscura/assets/characters/humanoid/source/Pro Sword and Shield Pack/sword and shield slash (3).fbx" \
    --target-blend-frames 8 \
    --output "games/selva-oscura/assets/characters/humanoid/source/Pro Sword and Shield Pack Reposed/sword and shield slash (3).fbx"
```
